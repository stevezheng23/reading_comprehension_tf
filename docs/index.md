...
![qanet_arch]({{ site.url }}/reading_comprehension_tf/QANet.architecture.png){:width="700px" display="block" margin="auto"}
<p align="center"><i>Figure 1: An overview of the QANet architecture</i></p>

![qanet_metric]({{ site.url }}/reading_comprehension_tf/QANet.metric.png){:width="1000px" display="block" margin="auto"}
...
![bidaf_arch]({{ site.url }}/reading_comprehension_tf/BiDAF.architecture.png){:width="700px" display="block" margin="auto"}
<p align="center"><i>Figure 3: An overview of the BiDAF architecture</i></p>

![bidaf_metric]({{ site.url }}/reading_comprehension_tf/BiDAF.metric.png){:width="1000px" display="block" margin="auto"}
...
![rnet_arch]({{ site.url }}/reading_comprehension_tf/R-Net.architecture.png){:width="700px" display="block" margin="auto"}
