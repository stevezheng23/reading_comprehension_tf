...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        model_representation_subword_dropout=0.1,
        ...
        model_representation_char_embed_dim=10,
        ...
        model_representation_fusion_unit_dim=200,
        ...
        model_interaction_context2quesiton_score_type="bilinear",
        ...
        model_interaction_quesiton2context_score_type="bilinear",
        ...
        model_interaction_fusion_unit_dim=200,
        ...
        model_interaction_enable_sharing=False,
        ...
        model_modeling_answer_score_type="bilinear",
        model_modeling_answer_attention_enable=True,
        model_modeling_answer_trainable=True,
        model_modeling_fusion_type="highway",
        model_modeling_fusion_num_layer=1,
        model_modeling_fusion_unit_dim=200,
        model_modeling_fusion_hidden_activation="tanh",
        model_modeling_fusion_dropout=0.1,
