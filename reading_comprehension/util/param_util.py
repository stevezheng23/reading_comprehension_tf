...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        model_representation_word_embed_trainable=True,
        model_representation_word_feat_enable=True,
        model_representation_subword_embed_dim=100,
        model_representation_subword_embed_trainable=True,
        ...
        model_representation_char_embed_trainable=True,
        ...
        model_representation_fusion_unit_dim=512,
        model_representation_fusion_cell_type="highway",
        model_representation_fusion_hidden_activation="tanh",
        model_representation_fusion_dropout=0.1,
        model_question_understanding_num_layer=1,
        model_question_understanding_unit_dim=512,
        model_question_understanding_cell_type="lstm",
        model_question_understanding_hidden_activation="tanh",
        model_question_understanding_residual_connect=False,
        model_question_understanding_dropout=0.1,
        model_context_understanding_num_layer=1,
        model_context_understanding_unit_dim=512,
        model_context_understanding_cell_type="lstm",
        model_context_understanding_hidden_activation="tanh",
        model_context_understanding_residual_connect=False,
        model_context_understanding_dropout=0.1,
        device_num_gpus=1,
