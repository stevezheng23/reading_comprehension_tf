...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        model_understanding_question_unit_dim=512,
        ...
        model_understanding_context_unit_dim=512,
        ...
        model_interaction_context2quesiton_score_type="additive",
        model_interaction_context2quesiton_trainable=True,
        model_interaction_quesiton2context_unit_dim=256,
        model_interaction_quesiton2context_score_type="additive",
        model_interaction_quesiton2context_trainable=True,
        model_interaction_context2context_unit_dim=256,
        model_interaction_context2context_score_type="additive",
        model_interaction_context2context_trainable=True,
        device_num_gpus=1,
