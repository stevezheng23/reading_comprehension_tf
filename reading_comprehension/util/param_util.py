...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        model_understanding_question_num_layer=2,
        ...
        model_understanding_context_num_layer=2,
        ...
        model_interaction_fusion_unit_dim=100,
        ...
        model_modeling_answer_attention_dim=256,
        model_modeling_answer_score_type="add",
        model_modeling_answer_attention_enable=True,
        model_modeling_answer_trainable=True,
        model_modeling_fusion_type="dense",
        model_modeling_fusion_num_layer=1,
        model_modeling_fusion_unit_dim=100,
