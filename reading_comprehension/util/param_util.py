...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        model_question_understanding_forget_bias=False,
        model_question_understanding_residual_connect=False,
        model_question_understanding_trainable=True,
        ...
        model_context_understanding_forget_bias=False,
        model_context_understanding_residual_connect=False,
        model_context_understanding_trainable=True,
        device_num_gpus=1,
