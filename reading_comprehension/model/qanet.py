...
class SubwordFeat(object):
    ...
    def __call__(self,
        ...
        with tf.variable_scope(self.scope, reuse=tf.AUTO_REUSE):
            ...
            (input_subword_pool,
                input_subword_pool_mask) = self.pooling_layer(input_subword_embedding, input_subword_embedding_mask)
...
class CharFeat(object):
    ...
    def __call__(self,
        ...
        with tf.variable_scope(self.scope, reuse=tf.AUTO_REUSE):
            ...
            (input_char_pool,
                input_char_pool_mask) = self.pooling_layer(input_char_embedding, input_char_embedding_mask)
